...
namespace Mati_Mongo.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            await InitAsync(vehiclePointService, cancellationToken);

            //await GetRecordsAsync(vehiclePointService, cancellationToken);

            async ValueTask GetRecordsAsync(IVehiclePointService vehiclePointService, CancellationToken cancellationToken = default)
            {
                {
            ...
            async ValueTask InitAsync(IVehiclePointService vehiclePointService, CancellationToken cancellationToken = default)
            {
                {
